...
print(network_passphrase)
soroban_server = SorobanServer(rpc_server_url)

# https://github.com/stellar/soroban-examples/tree/v0.6.0/auth
contract_id = "CDT4FXTGHXZBUBAOSF23QIV7KJ6MMJXL54YJW6TY3Z7WIKZ6UK6XHDU5"
tx_submitter_kp = Keypair.from_secret(
    "SBERKRKUCZUZB33623VWNSV6VD7ULU5NXA3VVKPZBDPIYLM725CYH4YY"
)
...
args = [scval.to_address(tx_submitter_kp.public_key), scval.to_uint32(100), scval.to_string("USDC"), scval.to_string("USDCs")]
