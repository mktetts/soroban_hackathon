...
secret = "SBERKRKUCZUZB33623VWNSV6VD7ULU5NXA3VVKPZBDPIYLM725CYH4YY"
rpc_server_url = "https://rpc-futurenet.stellar.org:443/"
contract_id = "CD3WGP5B2WKPIX3BRYBYBKUWVQTHHRJI5YQAQCKCLS7XMEKTR4VFURO4"
...
tx = (
    ...
    .append_invoke_contract_function_op(
        ...
        parameters=[scval.to_address(kp.public_key), scval.to_uint32(100), scval.to_string("USDC"), scval.to_string("USDCs")],
        # parameters=[]
    )
    .build()
)
